...
namespace AlphaMetrixForms.Web.Controllers
{
    public class DocumentQuestionController : Controller
    {
        ...
        private static readonly Dictionary<string, string> typesDictionary = new Dictionary<string, string>
    {
    ...
    {"zip", "application/zip"}
        ...
        public DocumentQuestionController(IDocumentQuestionService documentQuestionService)
        {
